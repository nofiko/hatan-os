...
chmod +x "$HAT_DIR/installer/iso-install.sh"
...
cp "$HAT_DIR/themes/splash/boot.png" "$PLYMOUTH_THEME/"
...
[Wayland]
CompositorCommand=gamescope -W 1280 -H 800 -f -- /opt/hatan-os/ui/shell/hat-shell.sh
SDDM
